...
public class BroadcastChangedEvent {
    ...
    public BroadcastChangedEvent(double id, boolean isBroadcasting, int activeBroadcast) {
        this(id, isBroadcasting, activeBroadcast, false);
    }

    public BroadcastChangedEvent(double id, boolean isBroadcasting,int activeBroadcast, boolean isFailure) {
        mId = id;
