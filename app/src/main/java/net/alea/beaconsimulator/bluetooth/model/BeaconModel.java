...
public class BeaconModel implements Parcelable {
    ...
    private BeaconModel(String name, double id, Settings settings) {
        this.name = name;
        this.id = id;
        this.settings = settings;
    }

    public BeaconModel(String name, double id, Settings settings, IBeacon ibeacon) {
    ...
    public BeaconModel(BeaconType type) {
        this("", SimpleUUID.randomSimpleUUID(), new Settings());
        this.type = type;
        switch (type) {
            case ibeacon:
